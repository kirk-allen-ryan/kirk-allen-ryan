...
In the current LLM revolution, technical skills have become commoditized. Almost anyone can now generate code; **value added code** will be written by those with the **domain wisdom** to know *what* to build and *why* it matters. 
